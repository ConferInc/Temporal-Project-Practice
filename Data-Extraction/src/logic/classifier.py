...
class ClassificationService:
    ...
    def classify_document(file_path: str) -> Dict[str, Any]:
        ...
        keywords = {
            ...
            DocumentType.FORM_1099_MISC: ['1099-misc', 'miscellaneous information', 'rents', 'royalties', 'other income', 'nonemployee compensation'],
            DocumentType.FORM_1099_INT: ['1099-int', 'interest income', 'tax-exempt interest'],
            DocumentType.FORM_1099_DIV: ['1099-div', 'dividends and distributions', 'capital gain distributions'],
        ...
        regex_patterns = {
            ...
            DocumentType.FORM_1099_MISC: [r'Form\s+1099-MISC', r'1099-MISC'],
            DocumentType.FORM_1099_INT: [r'Form\s+1099-INT', r'1099-INT'],
            DocumentType.FORM_1099_DIV: [r'Form\s+1099-DIV', r'1099-DIV'],
