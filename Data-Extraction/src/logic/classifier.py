...
class ClassificationService:
    ...
    def classify_document(file_path: str) -> Dict[str, Any]:
        ...
        keywords = {
            ...
            DocumentType.IRS_FORM_4506C: ['form 4506-c', 'request for transcript of tax return', 'ives request', 'omb no. 1545-1872', 'name of ivs participant'],
            ...
            # Utilities
            DocumentType.UTILITY_BILL: ['account number', 'payment due', 'invoice', 'messaging for all inquiries', 'utility bill', 'service address', 'account name']
        }
        
        # B. Regex Patterns
        regex_patterns = {
            DocumentType.W2_FORMS: [r'Wage and Tax Statement', r'Form W-2'],
            ...
            DocumentType.IRS_FORM_4506C: [r'Form\s+4506-C', r'OMB\s*No\.\s*1545-1872'],
            DocumentType.VA_FORM_26_1880: [r'26-1880'],
            DocumentType.VA_FORM_26_8937: [r'26-8937'],
            DocumentType.UTILITY_BILL: [r'Payment\s+Due', r'Account\s+Number']
        }
        ...
        complex_types = [
            ...
            DocumentType.BANK_STATEMENTS, DocumentType.PAY_STUBS,
